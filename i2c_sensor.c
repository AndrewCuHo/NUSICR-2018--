...
// ygtemp=0;
// for(ii=0;ii<100;ii++)
// {  xgtemp += Get_X_Gyro();//读x轴角速度，转向
//    I2C_DELAY();
//    ygtemp += Get_Y_Gyro();//读z轴角速度，转向
//    I2C_DELAY();
//  }
//  Gyro_X_Offset =  -311; //xgtemp/100;        //静态X轴角速度值，直立，理论上为0，但实际可能不为0
//  Gyro_Y_Offset =  58;   //ygtemp/100;        //静态X轴角速度值，直立，理论上为0，但实际可能不为0
